...
const RegisterPage = () => {
  ...
  return (
    <div className="flex overflow-hidden relative items-center justify-center min-h-screen bg-[#6363FC]">
      <div className="w-full z-2 max-w-[24rem] p-8 space-y-6 bg-white rounded-xl shadow-md">
        ...
        <a href="https://velochat-backend-restful-apis-production.up.railway.app/api/auth/google" className="flex items-center justify-center border rounded-[7px] hover:rounded-[60px] transition-all py-2">
